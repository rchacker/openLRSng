...
uint8_t FSstate = 0; // 0 = dont send,  2 = send FS,
uint32_t FStime = 0;  // time when FS set.
const uint32_t FS_TIMEOUT = 100; //amount of time in milliseconds to send failsafe packets
